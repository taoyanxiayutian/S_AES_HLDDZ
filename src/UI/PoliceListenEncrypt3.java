...
public class PoliceListenEncrypt3 implements MyCommandListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (!binaryPlaintext.isEmpty()) {
            ...
            String ciphertext2 = funcforaes.decrypt(ciphertext1, keyA2Text);
            String ciphertext3 = funcforaes.encrypt(ciphertext2, keyA1Text);
            outputEncrypt.append("二进制明文加密结果: " + ciphertext3 + "\n");
        } else {
