...
public class CBCmain extends JFrame {
    private JFrame frame;
    private JTabbedPane jtbp_4;
    ...
    private void initializeUI() {
        ...
        //明文
        jlabEncrypt2 = new JLabel("IV(16位)");
        ...
        jlabEncrypt3 = new JLabel("二进制明文(any位)");
        ...
        //key2
        jlabDecrypt2 = new JLabel("IV(16位)");
        ...
        jlabDecrypt3 = new JLabel("二进制密文(any位)");
    ...
    public void displayWindow() {
        ...
        // 添加选项卡
        jtbp_4.addTab("加密", jpEncrypt);
        jtbp_4.addTab("解密", jpDecrypt);
        jtbp_4.setFont(new Font("楷体", Font.BOLD, 15));

        // 设置选项卡外观
        jtbp_4.setForeground(new Color(50, 100, 0));
        jtbp_4.setBorder(BorderFactory.createEmptyBorder());

        // 设置内容面板
        frame.setContentPane(jtbp_4);
        frame.pack();
